...
const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <>
      <nav className="fixed overflow-hidden top-0 left-0 w-full py-[.3rem] border-b-[1px] border-b-[#bebebe] bg-white z-50">
        <div
          className={`flex ${
      ...
      {/* {isProfileOpen && (
        <div onClick={toggleProfile} className="fixed inset-0 z-10 "></div>
      )} */}
    </>
  );
};
