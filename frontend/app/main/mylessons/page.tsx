  ...
  return (
    <div
      className={`transition-all duration-300 ease-in-out ml-0 ${
        isSidebarOpen ? "ml-[5.5rem] w-[calc(100%-5.5rem)]" : "ml-0 w-full"
      }`}
    >
      <Navbar
      ...
      <div className="mt-16 p-6">
        <div className="ml-[200px] w-[1520px]">
          ...
          <div className="w-full rounded-xl h-[160px] bg-[#D9D9D9] shadow-custom mt-4">
            <div className="mx-8 pt-2">
              ...
              <p className="text-[#666666]">
                Explore the basics of linear equations, solving techniques, and
          ...
          <div className="w-full rounded-xl h-[160px] bg-[#D9D9D9] shadow-custom mt-4">
            <div className="mx-8 pt-2">
              <h1 className="text-[24px] font-semibold">Quadratic Equations</h1>
              <p className="text-[#666666]">
                Understand the structure of quadratic equations and how to find
                their roots.
              </p>
